...
export const metadata = {
  title: "ValoJump | Interactivos",
  description:
    "Experiencia de salto gamificada que combina actividad física, tecnología y entretenimiento para eventos y retail.",
}
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-background via-card to-background">
        ...
        <div className="container relative z-10 mx-auto px-4 py-16">
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-[family-name:var(--font-space-grotesk)] leading-tight text-balance">ValoJump</h1>
            <p className="text-lg text-muted-foreground">
              Salto gamificado que atrae audiencias y genera alto engagement, perfecto para eventos, retail y centros de entretenimiento.
            </p>
            <div className="flex gap-3">
              ...
              <Button variant="outline" asChild>
                <a href="https://luisgarciamoreno95.wixsite.com/monster1/valojump" target="_blank" rel="noreferrer">Fuente</a>
              </Button>
            </div>
          </div>
        </div>
