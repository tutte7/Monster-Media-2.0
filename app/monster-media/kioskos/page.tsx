...
export const metadata = {
  ...
  description:
    "Kioskos interactivos como centros de carga, con experiencias táctiles, contenido de marca y juegos derivados.",
}
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-background via-card to-background">
        ...
        <div className="container relative z-10 mx-auto px-4 py-16">
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-[family-name:var(--font-space-grotesk)] leading-tight text-balance">Kioskos</h1>
            <p className="text-lg text-muted-foreground">
              Kioskos interactivos que combinan utilidad y marketing: carga de dispositivos, interfaces táctiles, promociones y dinámicas.
            </p>
            <div className="flex gap-3">
              ...
              <Button variant="outline" asChild>
                <a href="https://luisgarciamoreno95.wixsite.com/monster1/kioskos" target="_blank" rel="noreferrer">Fuente</a>
              </Button>
            </div>
          </div>
        </div>
